...
const instaturbo = 'https://www.instagram.com/turbo98._'
//--anti delete 
antidel = false
ngetik = false
vn = true
...
const linkwa = 'https://chat.whatsapp.com'
    ...
    if (budy.includes(`https://chat.whatsapp.com/Ly4I2LObSvW8VgOnJfgA`)) return reply('✳️ Menos mal que este enlace es del grupo *📲💻ANDROID WORLD🎬🎮* v:')
...
_*Fb*_ : facebook.com/turbo98A
_*Fb*_ : facebook.com/turbo98ff
▢ *CRISS* :
@${crisnum.split("@")[0]}
...
▢ Instagram :
https://www.instagram.com/turbo98._
▢ BASE :
https://github.com/Turbo98F/turbobotv3
▢ DUEÑO :
https://github.com/Turbo98F`
mentions(infobot, [turbonum, crisnum], true)
break
...
var mantap2 = await convertSticker(bas642, `💎 @turbo98._`, `🔮 DyLux ┃ ᴮᴼᵀ`)
...
var mantap2r = await convertSticker(bas642r, `💎 @turbo98._`, `🔮 DyLux ┃ ᴮᴼᵀ`)
...
var mantap2c = await convertSticker(bas642c, `💎 @turbo98._`, `🔮 DyLux ┃ ᴮᴼᵀ`)
